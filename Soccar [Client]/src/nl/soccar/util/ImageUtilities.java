...
public final class ImageUtilities {
     ...
     * 
     * @param carType The CarType of the image. This will be used to determine what file the image should be loaded from.
     * @param teamColour The TeamColour of the image. This will be used to determine what file the image should be loaded from.
